...
class epel::params {
  ...
  $epel_debuginfo_priority                = 'absent'
  ...
  $epel_testing_source_priority           = 'absent'
  ...
  $epel_testing_debuginfo_priority        = 'absent'
